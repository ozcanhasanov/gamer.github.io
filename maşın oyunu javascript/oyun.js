...
var player = new function(){
    ...
    this.drawInterface = function(){
        ...
        //interce draw
        if(mobilmi){
        ctx.drawImage(this.leftBtn,70,c.height - 140,120,120);
        ctx.drawImage(this.rightBtn,200,c.height - 140,120,120);
        ctx.drawImage(this.fireBtn,c.width - 140,c.height - 140,120,120);
        }
    }else{
            ...
            ctx.drawImage(this.startBtn,(c.width / 2) - 50, (c.height / 3) + 50,100,100);
        }
    }
